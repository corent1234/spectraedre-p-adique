...
\begin{figure}
  \centering
  \includegraphics[scale=0.2]{IMAGES/fermat4}
  \caption*{The convex hull of the Fermat's quartic $x^4+y^4=1$, \\
    which is semidefinite representable but not spectrahedral}
\end{figure}
