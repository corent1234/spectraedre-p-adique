...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{\vspace{-0.5cm}\bc \bf Motivations\ec}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{\vspace{-0.5cm}\bc \bf Properties\ec}

Polyhedra and spectrahedra {\bf \color{blue} share} several properties, for instance:

\begin{itemize}
\item convex basic semi-algebraic sets
...
but spectrahedra/SDP suffer of {\bf \color{red} pathologies} that do not show up for polyhedra/LP:

\begin{itemize}
\item spectrahedra are not closed under linear image
\item points of spectrahedra might not be representable over the defining field, e.g.:
  $$
  \{\sqrt{2}\} = \left\{x \in \RR :
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{\vspace{-0.5cm}\bc \bf Spectrahedral shadows\ec}
