...
\end{lemma}
\begin{proof}
  If $\PP$ is defined (in matrix form\footnote{je pense qu'il faut introduire avant
  cette notation}) by
  \[
  \PP=\left\lbrace x \in K^n,  Ax+B \geq 0, Cx+D=0 \right\rbrace
  \] and $U$ is the matrix of
  $f$ in the canonical basis of $K^n$, 
  let
