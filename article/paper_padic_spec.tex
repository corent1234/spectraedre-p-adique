...
\begin{remark}
  ...
  unless $A_1,\ldots,A_n$ are linearly independent.
\end{remark}
...
\end{proposition}
\begin{proof}
  Let $P = L \cap M$ be a polyhedron in $K^n$, with
  \begin{equation*}
    \begin{aligned}
