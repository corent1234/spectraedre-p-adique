...
j=1,\ldots,e\}$. The \emph{dimension} of $P$ is defined as the dimension of $\aff{P}$ (for $e=0$,
...
\begin{definition}
  ...
  The set $\mathcal{L} \cap \mathcal{M}_n^+(K)$ or equivalently,
  its canonical preimage in $K^n$:
  $$
  S_A = \{x \in K^n : A_0+x_1A_1+\cdots+x_nA_n \succeq 0\},
  $$
