...
{\bf normalement avec la nouvelle definition, ça devrait aller, peut être il faudrait
  diviser la proposition en plusieures parties pour la rendre plus lisible}.
...
and $\Delta \in \allmat_{n,m}(K)$ of the form $\diag(\lambda_1, \ldots, \lambda_r, {\bf 0}_{\min(m,n)-r})$
