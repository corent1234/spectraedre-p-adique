...
\begin{example}
  ...
  \max_i\{X_i\}\leq 1$, other words, such that $\val(X_i) \geq 0$, for all $i=1, \ldots, n$.
...
\end{array}
\end{equation}
with $c \in K^n$ a fixed vector of size $n$ that represents the cost, $A \in \allmat_{m,n}(K)$ and $b \in K^m$.
