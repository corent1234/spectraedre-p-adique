...
\begin{remark}
  ...
  Thus we have\footnote{\simone{Est-ce vrai parce que $P_E$ est affine? Car en général il faut que
    $f$ soit injective}} $f(P) = f(P_I) \cap f(P_E)$. However $P_E$ is either empty or an affine subspace of
