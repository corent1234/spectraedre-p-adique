...
are defined as the set of vectors whose entries have valuation nonnegative or infinite and satisfying
some linear constraint, {\it i.e.} subsets of the form
...
one can make the following assumptions (which is what we do from now on):

\begin{assumption}\label{assumpt}
  Let $\PP$ be given as in \ref{eq_def_polyhedra}.
  \begin{itemize}
  \item[A.]
