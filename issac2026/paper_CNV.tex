...
are in general not spectrahedra. It has been conjectured by Helton and Nie
\cite{helton_sufficient_2008} that every convex semialgebraic set admits
a semidefinite representation, {\it i.e.} is the projection of a spectrahedron,
but this has been disproved by Scheiderer that exhibited compact counterexamples
\cite{scheiderer_spectrahedral_2017}.

This gap in the geometry of polyhedra versus spectrahedra is also reflected
...
in some affine space all of whose eigenvalues have nonnegative valuation in some algebraic
closure of $K$.
