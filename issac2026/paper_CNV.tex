...
over a valued field $K$. A spectrahedron over $K$ is defined as the set of matrices
...
that are semidefinite-representable but not spectrahedral, under mild assumptions:
