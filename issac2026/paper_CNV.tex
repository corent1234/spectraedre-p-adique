...
In this section, we define polyhedra over a \rev{complete discrete}\footnote{On utilise vraiment le ``complete'' et ``discrete'' ici ? en tous cas pas pour la définition} valued field $K$ with valuation $\val$ and a uniformizer $\pi$, and we prove that the class of polyhedra is closed under linear transformations, as in the real case. 
