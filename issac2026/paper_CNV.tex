...
The study of real polyhedra and of linear programming (LP) is at
...
\cite{iriarte2022polyhedral,allamigeon_tropical_2020} and tropical methods applied to non-archimedean SDP
...
We conclude proving that, in general, annuli are not spectrahedra.

\begin{proof}[{Proof of \Cref{main_2}}]
Assume that the residue field $\kappa = \OK/\mathfrak{m}_K$ of $K$ is infinite.
