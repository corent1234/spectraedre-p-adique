...
positive semidefinite affine combinations of some real symmetric matrices.
The latter problem has interested the community of real algebraic
geometry and polynomial optimization, mostly because of the relaxation
method known as moment-SOS hierarchy \cite{henrion2020moment}.
...
are in general not spectrahedra. Compact examples of convex semialgebraic
sets that do not admit a semidefinite representation have been exhibited
by Scheiderer \cite{scheiderer_spectrahedral_2017}, answering a conjecture
of Helton and Nie \cite{helton_sufficient_2008}.

This gap in the geometry of polyhedra and spectrahedra reflects on different
behaviors of LP and SDP. 
...
The main motivation for studying spectrahedra and SDP from an effective viewpoint
is the fact that the complexity status of SDP is, contrary to the LP case, widely open.
...
under application of affine maps:
