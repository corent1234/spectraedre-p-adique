...
Assuming the input data belongs to an effective field $K$ (\emph{e.g.} $K =
\QQ$) then a solution can be described and computed as element of a vector
space over some algebraic extension of $K$. For exact computation, complexity
