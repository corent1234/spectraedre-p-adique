...
called {semidefinite-representable sets}: these are sets of the form
$$
...
\begin{example}
  ...
  $\ell_i(x)=x_i$, $i=1,\ldots, n$, and $e=0$, {\it i.e.} $O_K^n = \{x \in K^n : x \succeq 0\}$.
