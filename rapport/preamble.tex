...
%\usepackage[ruled,lined,french]{algorithm2e}%pour faire du pseudo-code
%\include{algo.tex}%pour faire du pseudo code qui marhce ? 
...
\newmdtheoremenv[nobreak=true]{proprietes}{Propriétés}
