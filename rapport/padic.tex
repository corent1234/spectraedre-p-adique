...
Le principal intérêt qu'offre la notion de valuation pour le sujet développé ici est qu'elle permet de définir une notion de positivité dans un corps qui n'est pas totalement ordonnable \todo{i.e.}. À cet effet on introduira la notation suivante :
\begin{notation}
